...
import com.controller.carers.MainActivityCarers;
import com.controller.mentors.MainActivityMentor;
	...
	public void empiezaActividadSegunUsuario(String tipoUsuario){
		...
		switch (tipoUsuario){
			case "administrator":
				...
				break;
			case "cuidador":
				intent = new Intent(Login.this, MainActivityCarers.class);
				break;
			case "familiar":
				intent = new Intent(Login.this, MainActivityMentor.class);
				break;
		}
		startActivity(intent);
		finish();
