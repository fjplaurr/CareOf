...
public class SignUpAdmin extends AppCompatActivity {
	...
	@Override
	    protected void onCreate(Bundle savedInstanceState) {
			...
			getSupportActionBar().setTitle("Registrar administrator");

			//Inicio instancia del ProgressDialog
			mRegProgress=new ProgressDialog(this  );
	        
	        //configuramos el boton de registrar administrator
	        ...
	        btnRegistrarAdmin.setOnClickListener(new OnClickListener() {
	            ...
	            public void onClick(View v) {
					...
					mRegProgress.setTitle("Registrando administrator");
		...
		mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
			...
			public void onComplete(@NonNull Task<AuthResult> task) {
				if (task.isSuccessful()) {
					...
					userMap.put("tipousuario","administrator");
					...
					mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
						...
						public void onComplete(@NonNull Task<Void> task) {
							if(task.isSuccessful()){
								...
								Intent mainIntent=new Intent(SignUpAdmin.this,MainActivityAdmin.class);
